...
class NoeudInstRep : public Noeud {
    private:
        Noeud * m_cond;
        Noeud * m_seq;

    public:
        NoeudInstRep(Noeud * cond, Noeud * seq);
        int executer();
};
...
class NoeudInstPour : public Noeud {
    private:
        ...
        Noeud * m_seq ;
    public: 
        NoeudInstPour(Noeud * aff, Noeud* cond, Noeud * incr, Noeud * seq);
        int executer();
};
class NoeudInstSiRiche : public Noeud{
    ...
    public:
        int executer();
        NoeudInstSiRiche(Noeud* cond, Noeud* m_seq1, vector<Noeud*> & exps, vector<Noeud*> & seqs, Noeud* seq2 );
};
